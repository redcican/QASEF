"""Experiment: Noisy data setting (Table 4 in the paper).

Evaluates QASEF under Gaussian noise with sigma in {0.1, 0.3, 0.5}.
"""
...
from qasef.utils import add_gaussian_noise
...
def run_noisy(dataset_name: str, data_dir: str | None = None):
    ...
    for sigma in NOISE_LEVELS:
        ...
        for run in range(N_RUNS):
            ...
            pred = model.fit_predict(noisy_views)
